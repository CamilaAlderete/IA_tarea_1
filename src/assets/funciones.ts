...
export function toString(cuadricula:number[][]){
...
/*
export function writeFile(str:any, nombreArchivo:any){
...
export function actualizarCuadricula(cuadricula:number[][], matrizValoresRestantes:any[][], fila:any, columna:any){
    /*
...
export function inicializarMatrizVR(cuadricula:number[][]){
    /*
    ...
    */
    ...
    let matrizValoresRestantes:any = [];
...
export function printRegion(cuadricula:number[][], fila:any, columna:any){
...
export function inicializalizarMRV(cuadricula:number[][], matrizValoresRestantes:any[][]){
...
export function removeAll(originalSet:any, toBeRemovedSet:any) {
    /*
...
export function actualizarFila(cuadricula:number[][], matrizValoresRestantes:any[][], fila:any){
...
export function actualizarColumna(cuadricula:number[][], matrizValoresRestantes:any[][], col:any){
...
export function actualizarRegion(cuadricula:number[][], matrizValoresRestantes:any[][], fila:any, columna:any){
    /*
...
export function copiarMatrizValoresRestantes(matrizValoresRestantes:any[][]){
...
export function copiarSudoku(cuadricula:any[][]){
...
export function calcularSalto(dimMatriz:any){
